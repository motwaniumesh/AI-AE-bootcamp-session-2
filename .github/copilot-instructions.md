...
- [UI Guidelines](../docs/ui-guidelines.md) - Visual design and UX standards for the TODO app
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles, frameworks, and conventions
- [Coding Guidelines](../docs/coding-guidelines.md) - Coding style, formatting, and quality principles
